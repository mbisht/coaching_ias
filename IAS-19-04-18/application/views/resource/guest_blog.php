                ...
                <div class="entry-body">
                    ...
                    <div class="entry-author"><i class="fa fa-user" aria-hidden="true"></i> <?php echo $value['full_name']; ?></div>
							<div class="entry-meta">
							    ...
							    <span class="posted-on"><time class="entry-date published updated" datetime=""><?php echo date("F d, Y", strtotime($value['date_added'])); ?></time</span>
							    </div>
							</div>
							<div class="entry-content">
							    <?php echo substr(strip_tags($value['description']),0,500); ?>...
							    <br>
							    <a href="guest-blog/<?php echo $value['slug']; ?>" class="readmore">Continue Reading <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
							</div>
				</div>
            </article>
            <?php } ?>
