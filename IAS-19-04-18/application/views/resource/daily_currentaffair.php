...
<section class="content news">
		<div class="container">
            <div>
                <h1 class="mt-0 text-uppercase font-28 line-bottom line-height-1">Daily <span class="text-theme-color-2 font-weight-400">CURRENT AFFAIRS</span></h1>
                    <div class="col-xs-12 col-sm-3">
                    <h3>GET CURRENT AFFAIR BY Date</h3>
                    ...
                    <div class="col-xs-12 col-sm-9 news-container">
                        <div class="preloaders"><img src="<?php echo base_url(); ?>assets/images/preloaders/1.gif" alt="preloaders" title="preloaders" /></div>
                    		 <table class="news-table table jsgrid table-striped table-bordered dataTable table-responsive" id="table-1">
                    		     ...
                    		     <td><h3>".$value["title"]." Current Affairs for ".$value["date"]."</h3></td></tr>";
                    		     }
                    		     ?>
                    		     </tbody>
                    		 </table>
...
<script type="text/javascript">
    ...
    function loadSiasaVideos(date){
        ...
        $.ajax({type: "POST",url: "<?php echo base_url(); ?>load-daily-currentaffair",data: {date : date},cache: false,
