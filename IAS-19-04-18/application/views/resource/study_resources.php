...
<section class="content about">
		...
		<div class="section-title mt-5 mb-5">
          <div class="row">
            <div class="col-md-12">
              <h1 class="mt-0 text-uppercase font-28 line-bottom line-height-1">STUDY <span class="text-theme-color-2 font-weight-400">RESOURCES</span></h1>
           </div>
          </div>
        </div>
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="nav nav-pills four">
					    <?php
					    $count=1;
					    foreach($study_material_data['subjects'] as $value){?>
						...
						<div id="tab-o-<?php echo $count; ?>" class="row tab-pane fade <?php if($count == 1){ echo 'active in';} ?>">
							<div class="col-lg-12 col-md-12">
								...
								<div class="item-main">
									<ul class="links">
									    <?php
									    foreach($study_material_data[$value] as $material){?>
