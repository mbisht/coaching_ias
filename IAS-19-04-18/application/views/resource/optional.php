...
<section class="content prelims">
	...
	<div class="os-inner">
		<div class="section-title mt-0 mb-0">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mt-0 text-uppercase font-28 line-height-1">Optional <span class="text-theme-color-2 font-weight-400">Course</span></h2>
           </div>
          </div>
        </div>
			...
			<div class="row">
				<div class="col-md-4">
					<ul class="nav nav-pills five">
					    <?php
					    $count=1;
					    foreach($optional_course_data as $value){?>
