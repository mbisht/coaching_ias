...
class Mail extends CI_Controller {
    ...
    public function send_mail($from='form@webliststore.in',$to='form@webliststore.in',$subject='Test Mail from World Vision Cable',$message='',$cc='form@webliststore.in',$bcc=''){
