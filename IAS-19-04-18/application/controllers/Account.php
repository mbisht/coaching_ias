...
class Account extends CI_Controller {
	...
	public function prelims_test_result(){
	    $data['notification_data']=$this->All_page->GetNotificationDetails();
	    $data['alert_notification_data']=$this->All_page->GetAlertNotification();
	    $data['activepage']="account";
	    ...
	    if(isset($this->session->userdata['logged_in'])){
		    $session_user_data=$this->session->userdata['logged_in'];
    		$data['getPrelimsDetails']=$this->Account_details->getPrelimsDetails($session_user_data['id']);
    		$this->load->view('account/prelims_test_result', $data);
        }else{
            redirect(base_url()."login");
        }
	}
	
	public function mains_test_result(){
	    $data['notification_data']=$this->All_page->GetNotificationDetails();
	    $data['alert_notification_data']=$this->All_page->GetAlertNotification();
	    $data['activepage']="account";
	    ...
	    if(isset($this->session->userdata['logged_in'])){
		    $session_user_data=$this->session->userdata['logged_in'];
    		$data['getMainsDetails']=$this->Account_details->getMainsDetails($session_user_data['id']);
    		$this->load->view('account/mains_test_result', $data);
        }else{
            redirect(base_url()."login");
        }
	}
	
	public function optional_test_result(){
	    $data['notification_data']=$this->All_page->GetNotificationDetails();
	    $data['alert_notification_data']=$this->All_page->GetAlertNotification();
	    $data['activepage']="account";
	    ...
	    if(isset($this->session->userdata['logged_in'])){
		    $session_user_data=$this->session->userdata['logged_in'];
    		$data['getOptionalDetails']=$this->Account_details->getOptionalDetails($session_user_data['id']);
    		$this->load->view('account/optional_test_result', $data);
        }else{
            redirect(base_url()."login");
        }
	}
