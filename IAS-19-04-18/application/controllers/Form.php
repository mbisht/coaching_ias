...
class Form extends CI_Controller {
	...
	public function contact(){
	    ...
	    $this->form_validation->set_rules('inquiry_name', 'Full Name', 'trim|required|alpha_numeric_spaces|xss_clean');
         $this->form_validation->set_rules('inquiry_email', 'Email ID', 'trim|xss_clean|required|valid_email');
         $this->form_validation->set_rules('inquiry_phone', 'Mobile Number', 'trim|xss_clean|required|numeric|exact_length[10]');
