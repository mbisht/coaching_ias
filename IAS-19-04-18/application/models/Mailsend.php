...
class Mailsend extends CI_Model{
   ...
   public function send_mail($from='info@iasshiksha.com',$to='info@iasshiksha.com',$subject='Test Mail from World Vision Cable',$message='',$cc='info@iasshiksha.com',$bcc=''){
	    ...
	    $message_html = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8">
                        ...
                        *, *:before, *:after { -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; }
                        ...
                        <tr>
                            ...
                            <span style="font-size: 0; line-height: 0"><a href="https://www.iasshiksha.com" target="_blank" rel="noreferrer"><img src="https://www.iasshiksha.com/assets/images/logo-wide.png" width="200" border="0"></a></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" bgcolor="#0093de" style="padding: 30px; font-size: 16px;font-weight: bold; text-align: center; color: #fff">
                            <span style="color:#fff;">Shiksha IAS Academy! </span> Best IAS Coaching Center in Bangalore</td>
                        </tr>
                        <tr>
                        <td colspan="4" style="padding: 30px 20px 10px; font-size: 14px">
                            <div>'.$message.'</div>
                            <br><br>
                            <div>Since, internet users are increasing day by day, we are focusing on providing unparalleled services to the customers. <a href="https://www.iasshiksha.com" style="color:#de1d3c;"><b>Shiksha IAS Academy</b></a>.</div>
                            <br></td>
                        </tr>
                        <tr><td colspan="4" style="padding: 20px; font-size: 14px"><div style="font-size: 14px"> <span>Regards,</span></div>
                            <div style="font-size: 14px; padding-top: 10px"> <span>Team Shiksha IAS Academy</span> </div></td>
                        </tr>
                        <tr>
